# econometric_data/econometric_modes/randomforest_regression_model.py
...
def create_widgets(column_names, date_columns):
    """
    Create interactive widgets for selecting Y, Categorical X, and Continuous X variables for Random Forest Classification.
    """
    y_variable_text = widgets.HTML(value=f"<b>Selecting variables for <span style='color:#228B22'>Random Forest Classification</span> model:</b>")
    dependent_variable_text = widgets.HTML(value="<b>Please Select the '<span style='color:#1E90FF'>Dependent Variable</span>' for Classification:</b>")
...
def display_widgets():
    """
    Main function to display the widgets for Random Forest Classification variable selection.
    """
